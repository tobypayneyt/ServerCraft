...
namespace pocketmine {
	...
	function server(){
		if(count($messages = check_platform_dependencies()) > 0){
			...
			critical_error("This is usually because you have a PHP binary without the needed extensions, or your PHP is outdated. Re-run the installer or refer to the docs at https://docs.servercraftpe.cf/docs");
			echo PHP_EOL;
			exit(1);
		}
		unset($messages);
